...
export const api = {
  ...
  applyEffectsToEpisode: (pid: string, charId: string) => // #103: return { task_ids, total, skipped } /* #108: changed response type */
    request<{ task_id: string; status: string; total: number; skipped: number; char_name: string }>(
